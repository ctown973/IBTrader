...
import static ib.connect.client.network.Types.AlgoParam.allowPastEndTime;
import static ib.connect.client.network.Types.AlgoParam.catchUp;
import static ib.connect.client.network.Types.AlgoParam.componentSize;
import static ib.connect.client.network.Types.AlgoParam.displaySize;
import static ib.connect.client.network.Types.AlgoParam.endTime;
import static ib.connect.client.network.Types.AlgoParam.forceCompletion;
import static ib.connect.client.network.Types.AlgoParam.getDone;
import static ib.connect.client.network.Types.AlgoParam.giveUp;
import static ib.connect.client.network.Types.AlgoParam.maxPctVol;
import static ib.connect.client.network.Types.AlgoParam.noTakeLiq;
import static ib.connect.client.network.Types.AlgoParam.noTradeAhead;
import static ib.connect.client.network.Types.AlgoParam.pctVol;
import static ib.connect.client.network.Types.AlgoParam.randomizeSize55;
import static ib.connect.client.network.Types.AlgoParam.randomizeTime20;
import static ib.connect.client.network.Types.AlgoParam.riskAversion;
import static ib.connect.client.network.Types.AlgoParam.startTime;
import static ib.connect.client.network.Types.AlgoParam.strategyType;
import static ib.connect.client.network.Types.AlgoParam.timeBetweenOrders;
import static ib.connect.client.network.Types.AlgoParam.useOddLots;
import static ib.connect.client.network.Types.AlgoParam.waitForFill;
