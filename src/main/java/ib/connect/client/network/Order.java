...
import ib.connect.client.network.Types.Action;
import ib.connect.client.network.Types.AlgoStrategy;
import ib.connect.client.network.Types.HedgeType;
import ib.connect.client.network.Types.Method;
import ib.connect.client.network.Types.OcaType;
import ib.connect.client.network.Types.ReferencePriceType;
import ib.connect.client.network.Types.Rule80A;
import ib.connect.client.network.Types.TimeInForce;
import ib.connect.client.network.Types.TriggerMethod;
import ib.connect.client.network.Types.VolatilityType;
