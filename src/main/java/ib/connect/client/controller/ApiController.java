...
package ib.connect.client.controller;
...
import ib.connect.client.controller.ApiConnection.ILogger;
...
import ib.connect.client.network.EClientErrors;
...
import ib.connect.client.network.ExecutionFilter;
import ib.connect.client.network.Order;
import ib.connect.client.network.OrderState;
import ib.connect.client.network.OrderStatus;
import ib.connect.client.network.ScannerSubscription;
import ib.connect.client.network.SoftDollarTier;
import ib.connect.client.network.TagValue;
import ib.connect.client.network.TickType;
import ib.connect.client.network.Types.BarSize;
import ib.connect.client.network.Types.DeepSide;
import ib.connect.client.network.Types.DeepType;
import ib.connect.client.network.Types.DurationUnit;
import ib.connect.client.network.Types.ExerciseType;
import ib.connect.client.network.Types.FADataType;
import ib.connect.client.network.Types.FundamentalType;
import ib.connect.client.network.Types.MktDataType;
import ib.connect.client.network.Types.NewsType;
...
public class ApiController implements EWrapper {
	...
	private void startMsgProcessingThread() {
		...
		final EReader reader = new EReader(m_client, signal);
